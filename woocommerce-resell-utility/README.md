...
### 1. 🏷️ Market & Reseller Price Display
...
### 2. ✍️ Reseller Custom Selling Price ("আপনার বিক্রয়মূল্য লিখুন")
...
- Fixes the classic WooCommerce catalog issue where cards with varying title lengths (1 line vs 3 lines) cause misaligned prices and buttons.
- Normalized 2-line title clamp, `margin-top: auto` on price elements, and flexbox button rows ensure **every Add to Cart and Buy Now button is 100% horizontally aligned across all cards**.
...
│   ├── class-wru-price-display.php        # Market & Reseller price filters
...
│   └── js/
│       ├── frontend.js                    # Live profit math, variation sync, copy tools
...
4. Toggle **Buy Now** buttons for single product and shop loop pages.
5. Toggle **Product Tools** (Image download & copy description).
6. Toggle **Reseller Dashboard** in My Account.
